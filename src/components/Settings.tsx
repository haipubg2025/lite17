                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between p-4 rounded-2xl bg-black/20 border border-white/5 gap-4">
                      ...
                      <select 
                        ...
                        className="bg-black/40 border border-white/10 rounded-xl px-4 py-2 text-white outline-none focus:border-blue-500 min-w-[200px] text-sm"
                      >
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between p-4 rounded-2xl bg-black/20 border border-white/5 gap-4">
                      ...
                      <select 
                        ...
                        className="bg-black/40 border border-white/10 rounded-xl px-4 py-2 text-white outline-none focus:border-blue-500 min-w-[140px]"
                      >
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between p-4 rounded-2xl bg-black/20 border border-white/5 gap-4">
                      ...
                      <select 
                        ...
                        className="bg-black/40 border border-white/10 rounded-xl px-4 py-2 text-white outline-none focus:border-blue-500 min-w-[180px]"
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="space-y-2 text-left">
                            ...
                            <select
                              ...
                              className="w-full px-5 py-4 rounded-xl bg-black/40 border border-white/5 focus:border-blue-500/50 text-white outline-none text-sm font-mono transition-colors"
                            >
