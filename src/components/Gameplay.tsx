    ...
    <div className="w-full h-full flex flex-col bg-transparent relative overflow-hidden">
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-start gap-3 mb-3">
                        {npc.avatar ? (
                          <div className="w-10 shrink-0 overflow-hidden rounded-md border border-white/20 aspect-[2/3]">
                            <LazyImage
                              src={npc.avatar}
                              alt="Avatar"
                          ...
                          <div className="w-10 shrink-0 bg-blue-500/20 flex items-center justify-center rounded-md border border-blue-500/30 aspect-[2/3]">
                        ...
                        <div className="flex flex-col gap-1 items-start flex-1 min-w-0">
                          ...
                          <span className="text-[10px] text-blue-400 bg-blue-500/10 px-2 py-0.5 rounded-full inline-block">
                            {npc.role || "Vai trò"}
                          </span>
                        </div>
                      </div>
                      <div className="flex items-start gap-1.5 test-xs text-white/50 bg-[#050505]/50 p-2 rounded-lg border border-white/5">
                        <MapPin
                          size={12}
                          className="text-green-400/70 shrink-0 mt-0.5"
                        />
                        <span className="whitespace-pre-wrap break-words leading-tight text-xs">
              ...
              <div className="md:hidden p-4 border-b border-white/10 shrink-0 bg-[#0a0a0a]">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <button
                    ...
                    className="p-1 px-2 rounded bg-red-500/10 text-red-400 hover:bg-red-500/20 text-xs font-bold"
                  >
                    ĐÓNG
                  </button>
                </div>
      ...
      <AnimatePresence>
        ...
        {showRules && (
          ...
          >
            <div className="bg-[#0a0a0a] border border-white/10 rounded-2xl w-full max-w-4xl max-h-[90vh] flex flex-col shadow-2xl">
        ...
        {showMemory && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="absolute inset-0 z-50 bg-black/95 backdrop-blur-xl flex flex-col overflow-hidden"
          >
            <div className="flex-1 w-full flex flex-col bg-[#050505] overflow-hidden shadow-2xl">
              {/* Header */}
        ...
        {showSettings && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="absolute inset-0 z-50 bg-black/90 backdrop-blur-xl flex flex-col p-4 md:p-6 overflow-hidden"
          >
            <div className="flex-1 w-full max-w-7xl mx-auto flex flex-col bg-[#050505] border border-white/10 rounded-3xl overflow-hidden shadow-2xl">
