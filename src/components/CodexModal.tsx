...
export default function CodexModal({ onClose }: { onClose: () => void }) {
  ...
  return (
    <motion.div initial={{ opacity: 0}} animate={{ opacity: 1}} exit={{ opacity: 0}} className="fixed inset-0 z-[100] bg-black/80 backdrop-blur-md flex items-center justify-center p-2 sm:p-4">
      <div className="bg-[#0a0a0a] border border-white/10 rounded-2xl w-full max-w-5xl h-[95vh] flex flex-col shadow-2xl">
